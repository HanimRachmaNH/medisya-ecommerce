...
$query = "SELECT id, category_id, name, description, price, original_price, images, quantity FROM products";
...
<div class="header mb-4 d-flex justify-content-between align-items-center">
    ...
    <div>
        <a href="add_product.php" class="btn btn-success me-3">+ Tambah Produk</a>
        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="<?= htmlspecialchars($product['images']); ?>" alt="Product Image" width="100"></td>
